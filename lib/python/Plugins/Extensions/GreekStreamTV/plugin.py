...
def Plugins(**kwargs):
    return [PluginDescriptor(name='GreekStreamTV', where=PluginDescriptor.WHERE_MENU, description=_('Watching live stream TV'), fnc=menu), PluginDescriptor(name='GreekStreamTV', where=[PluginDescriptor.WHERE_EXTENSIONSMENU, PluginDescriptor.WHERE_PLUGINMENU], description=_('Watching live stream TV'), icon='plugin.png', fnc=main)]
