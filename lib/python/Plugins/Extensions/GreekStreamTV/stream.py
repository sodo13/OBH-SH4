# 2015.04.11 12:58:31 CET
# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/GreekStreamTV/stream.py
"""
GREEK STREAM TV
...
def Plugins(**kwargs):
    return PluginDescriptor(name=_('GreekStreamTVPlayer'), description='Watching live stream TV', where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main, icon='plugin.png')
# okay decompyling stream.pyo 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.04.11 12:58:32 CET
